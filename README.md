...
# 扩展字段 image_urls
python scripts/xqapi_image.py edit "统一加雪景" -m <MODEL> --image-urls https://a/1.png https://a/2.png
```
...
```bash
python scripts/xqapi_image.py gen "x" -m <MODEL> --extra seed=42 --extra style=natural
```
